...
export default function FormValidation(){
    ...
    const onSubmitForm = (event) =>{
        let maxNumFiles = 3
        let maxSize = 300
        if(inputFile.current.file.length > maxNumFiles){
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className='form-group mb-3'>
                    ...
                    <textarea id='detail' name='detail' rows='2' maxLength='250' className='form-control form-control-sm'
                        {...register('detail',{required:true,minLength:1,maxLength:250})}>
                    </textarea>
                ...
                <div className='form-group mb-3'>
                    <label htmlFor='file'className='formLabel'>ภาพสินค้า *(ไม่เกิน 3 ไฟล์ ขนาดไฟล์สูงสุด 300 KB/ไฟล์)</label>
